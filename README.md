...
the website and the app against shared vectors in [`tests/`](./tests), whose legacy expectations
are generated by running the [vendored original implementation](./tests/original).
