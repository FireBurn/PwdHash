...
class ShareLegacyActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Authenticate and generate legacy password
        BiometricAuth.authenticate(
            activity = this,
            onSuccess = {
                val masterPassword = passwordStorage.getMasterPassword()!!
                val legacyPassword =
                    PasswordGenerator.generateLegacyPassword(masterPassword, domain)
                copyToClipboard(this, legacyPassword, "Legacy Password")
                Toast.makeText(this, "Legacy password copied for $domain!", Toast.LENGTH_SHORT)
                    .show()
                finish()
            },
